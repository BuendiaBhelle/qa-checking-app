...
const device = config.devices.desktop;
const version = config.versions.desktop.version3;


async function windows7(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.executeScript("return document.getElementsByTagName('li')[117].click()");
        await driver.sleep(1000);
