...
const version = config.versions.mobile.version11;


async function iphone_13_pro(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementsByTagName('li')[142].click()");
        await driver.sleep(1000);
