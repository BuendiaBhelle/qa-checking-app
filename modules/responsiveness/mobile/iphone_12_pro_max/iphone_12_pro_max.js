...
const version = config.versions.mobile.version13;


async function iphone_12_pro_max(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementsByTagName('li')[145].click()");
        await driver.sleep(1000);
