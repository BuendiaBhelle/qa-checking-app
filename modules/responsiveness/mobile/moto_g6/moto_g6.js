...
const version = config.versions.mobile.version8;


async function moto_g6(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.executeScript("return document.getElementsByTagName('li')[206].click()");
        await driver.sleep(1000);
