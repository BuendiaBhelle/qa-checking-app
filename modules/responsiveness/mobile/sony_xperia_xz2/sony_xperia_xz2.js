...
const version = config.versions.mobile.version7;


async function sony_xperia_xz2(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.executeScript("return document.getElementsByTagName('li')[205].click()");
        await driver.sleep(1000);
...
module.exports = { sony_xperia_xz2 };
