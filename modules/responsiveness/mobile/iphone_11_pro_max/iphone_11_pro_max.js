...
const version = config.versions.mobile.version14;


async function iphone_11_pro_max(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementsByTagName('li')[150].click()");
        await driver.sleep(1000);
...
module.exports = { iphone_11_pro_max };
