...
async function mobile(module_name, url, email, password, timestamp, lt_email, lt_password, lambdatest_site, devices, versions, brand, device_mobile) {
    ...
    try {
        ...
        // console.log(version_mobile);
        // for (let index = 10; index <= 15; index++) {
        //     var iphones = "version" + index;
        //     console.log(iphones);
        //     if (iphones) {
        //         await driver.findElement(By.id("apple-icon")).click();
        //     } 
        //     // else {
        //     //     await driver.findElement(By.id("android-icon")).click();
        //     // }
        // }
