...
const version = config.versions.mobile.version9;


async function lg_g6(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.executeScript("return document.getElementsByTagName('li')[207].click()");
        await driver.sleep(1000);
