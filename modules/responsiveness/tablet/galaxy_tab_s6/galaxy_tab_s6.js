...
const device = config.devices.tablet;
const version = config.versions.tablet.version3;


async function galaxy_tab_s6(url, email, password, timestamp) {
    ...
    try {
        ...
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementsByTagName('li')[251].click()");
        await driver.sleep(1000);
