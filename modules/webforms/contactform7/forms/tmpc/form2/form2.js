...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        let phone = await driver.executeScript("return document.getElementsByName('your-phone')[0]");
        phone.sendKeys("4806480839");
        await driver.sleep(1000);

        let message = await driver.executeScript("return document.getElementsByName('your-message')[0]");
        message.sendKeys("Please take note that this is a test submit form for Commercial - Cybersecurity Compliance. Please disregard if received. Thank you.");
        await driver.sleep(1000);
