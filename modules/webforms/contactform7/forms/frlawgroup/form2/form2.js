...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.name("contact-message")).sendKeys("Please take note that this is a test submit form for Contact Us Form - SB. Please disregard if received. Thank you.");
