...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        message.sendKeys("Please take note that this is a test submit form for Free SEO Quote. Please disregard if received. Thank you.");
        await driver.executeScript("return document.getElementsByName('checkbox-82[]')[0].click()");
