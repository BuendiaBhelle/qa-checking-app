...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.sleep(1000);
        let message = await driver.executeScript("return document.getElementsByName('ymessage')[0]");
        message.sendKeys("Please take note that this is a test submit form for Contact Us ( Page ). Please disregard if received. Thank you.");
        await driver.sleep(1000);
