...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        let name = await driver.executeScript("return document.getElementsByName('txtName')[0]");
        name.sendKeys("Primeview Test");
        await driver.sleep(1000);
        let phone = await driver.executeScript("return document.getElementsByName('txtPhone')[0]");
        ...
        await driver.sleep(1000);
        let subject = await driver.executeScript("return document.getElementsByName('txtSubject')[0]");
        ...
        message.sendKeys("Please take note that this is a test submit form for QUICK QUOTE (Footer). Please disregard if received. Thank you.");
        await driver.sleep(1000);
