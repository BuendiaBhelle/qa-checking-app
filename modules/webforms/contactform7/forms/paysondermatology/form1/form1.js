...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        let name = await driver.executeScript("return document.getElementsByName('fullName')[0]");
        ...
        message.sendKeys("Please take note that this is a test submit form for Request an Appointment. Please disregard if received. Thank you.");
        await driver.sleep(1000);
