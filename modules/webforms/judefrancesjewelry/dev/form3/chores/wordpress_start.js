...
const form_page = config.forms.judefrancesjewelry.form3;
const module_name = config.module_name;
const launch = config.launch.dev;
const form = config.webforms.judefrancesjewelry.dev.form3;
...
async function wordpressStart(domain, checkbox, username, password, email, timestamp) {
    ...
    await driver.executeScript("return document.getElementsByTagName('a')[332].click()");
