...
async function wordpressStart(domain, checkbox_cfhec, username, password, email) {
    ...
    let values = [
        ...
        domain + form_page,
        "Return Request Form",
        '[contact-form-7 id="9439" title="Return Request Form"]',
    ]
