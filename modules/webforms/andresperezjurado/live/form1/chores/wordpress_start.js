...
const wp_username = config.credentials.andresperezjurado.username;
const wp_password = config.credentials.andresperezjurado.password;
...
async function wordpressStart(domain, username, password, email, timestamp) {
    ...
    let values = [
        ...
        domain + form_page,
        "Custom Inquiry",
        '[contact-form-7 id="324" title="Custom Inquiry"]',
    ]
