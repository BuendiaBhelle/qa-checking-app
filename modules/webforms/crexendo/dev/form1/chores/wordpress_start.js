...
const form_page = config.forms.crexendo.form1;
const module_name = config.module_name;
const launch = config.launch.dev;
const form = config.webforms.crexendo.dev.form1;
...
async function wordpressStart(domain, username, password, email, timestamp) {
    ...
    let values = [
        ...
        '[contact-form-7 id="7624" title="Sign-Up for your Free Demonstration"]',
    ]
    ...
    await driver.executeScript("return document.getElementsByClassName('row-title')[7].click()");
