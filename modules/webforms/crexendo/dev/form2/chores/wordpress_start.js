...
const wp_username = config.credentials.crexendo.username;
const wp_password = config.credentials.crexendo.password;
const qa_email = config.qa_email;
const auth = config.auth;
const spreadsheetId = config.spreadsheetId;
const date = config.date;
const form_page = config.forms.crexendo.form2;
const module_name = config.module_name;
const launch = config.launch.dev;
const form = config.webforms.crexendo.dev.form2;
...
async function wordpressStart(domain, username, password, email, timestamp) {
    ...
    let values = [
        ...
        wp_password,
        domain + form_page,
        "Talk to a Consultant Form",
        '[contact-form-7 id="7891" title="Talk to a Consultant Form"]',
    ]
    ...
    await driver.executeScript("return document.getElementsByClassName('wp-menu-name')[10].click()");

    await driver.executeScript("return document.getElementsByClassName('row-title')[8].click()");
