...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("nf-field-1")).sendKeys("Primeview Test");
        await driver.findElement(By.id("nf-field-2")).sendKeys("qa@primeview.com");
        await driver.findElement(By.id("nf-field-3")).sendKeys("Please take note that this is a test submit form for Contact Form. Please disregard if received. Thank you.");
        // await driver.executeScript("return document.getElementsByClassName('btn-primary')[0].click()");
        await driver.findElement(By.id("nf-field-4")).click();
