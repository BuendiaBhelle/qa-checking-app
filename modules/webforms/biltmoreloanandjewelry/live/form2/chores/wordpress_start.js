...
const form = config.webforms.biltmoreloanandjewelry.live.form2;
...
async function wordpressStart(domain, username, password, email, timestamp) {
    ...
    let values = [
        ...
        wp_password,
        domain + form_page,
        "Request an Appraisal - Get a Loan",
        '[contact-form-7 id="41779" title="Request an Appraisal - Get a Loan"]',
    ]
    ...
    await driver.executeScript("return document.getElementsByClassName('row-title')[13].click()");
