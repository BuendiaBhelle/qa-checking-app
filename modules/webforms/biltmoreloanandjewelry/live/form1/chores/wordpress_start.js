...
const form = config.webforms.biltmoreloanandjewelry.live.form1;
...
async function wordpressStart(domain, username, password, email, timestamp) {
    ...
    let values = [
        ...
        wp_password,
        domain + form_page,
        "Request an Appraisal - Sell Your Jewelry",
        '[contact-form-7 id="41813" title="Request an Appraisal - Sell Your Jewelry"]',
    ]
    ...
    await driver.executeScript("return document.getElementsByClassName('row-title')[14].click()");
