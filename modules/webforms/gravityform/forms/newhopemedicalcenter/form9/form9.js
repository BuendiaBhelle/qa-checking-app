...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_10_1")).sendKeys("Primeview");
        await driver.findElement(By.id("input_10_2")).sendKeys("Test");
        await driver.findElement(By.id("input_10_13")).click();
        await driver.findElement(By.id("input_10_13")).sendKeys(Key.ARROW_DOWN + Key.ENTER);
        await driver.findElement(By.id("input_10_3")).sendKeys("qa@primeview.com");
        await driver.findElement(By.id("input_10_4")).sendKeys("4806480839");
        await driver.findElement(By.id("input_10_14")).sendKeys("Lead Test Submission");
        await driver.findElement(By.id("input_10_6")).sendKeys("Please take note that this is a test submit form for New PPC Form Test. Please disregard if received. Thank you.");
