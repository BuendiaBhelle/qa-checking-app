...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_8_1")).sendKeys("Primeview");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_2")).sendKeys("Test");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_3")).sendKeys("qa@primeview.com");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_4")).sendKeys("4806480839");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_5")).sendKeys("Test");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_6")).sendKeys("Lead Test Submission");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_8_7")).sendKeys("Please take note that this is a test submit form for Contact Us Page Form. Please disregard if received. Thank you.");
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementById('gform_submit_button_8').click()");
