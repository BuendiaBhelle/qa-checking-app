...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_4_1")).sendKeys("Primeview");
        await driver.findElement(By.id("input_4_2")).sendKeys("Test");
        await driver.findElement(By.id("input_4_3")).sendKeys("qa@primeview.com");
        await driver.findElement(By.id("input_4_4")).sendKeys("4806480839");
        await driver.findElement(By.id("input_4_5")).sendKeys("Lead Test Submission");
        await driver.findElement(By.id("input_4_6")).sendKeys("Please take note that this is a test submit form for Cancer Page Template Form. Please disregard if received. Thank you.");
