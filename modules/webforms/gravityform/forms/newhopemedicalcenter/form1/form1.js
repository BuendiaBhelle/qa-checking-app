...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_1_6")).sendKeys("Primeview");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_1_7")).sendKeys("Test");
        await driver.sleep(1000);
        ...
        await driver.sleep(1000);
        await driver.findElement(By.id("input_1_4")).sendKeys("Please take note that this is a test submit form for Home Page Contact. Please disregard if received. Thank you.");
        await driver.sleep(1000);
