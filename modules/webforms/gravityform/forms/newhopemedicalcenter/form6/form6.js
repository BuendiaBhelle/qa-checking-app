...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_7_1")).sendKeys("Primeview");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_7_2")).sendKeys("Test");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_7_3")).sendKeys("qa@primeview.com");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_7_4")).sendKeys("4806480839");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_7_5")).sendKeys("Please take note that this is a test submit form for Quick Contact Sidebar Form. Please disregard if received. Thank you.");
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementById('input_7_7_1').click()");
        await driver.sleep(1000);
        await driver.executeScript("return document.getElementById('gform_submit_button_7').click()");
