...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_1_3")).sendKeys("(480) 648-0839");
        await driver.findElement(By.id("choice_1_4_1")).click();
        await driver.findElement(By.id("input_1_5")).sendKeys("Please take note that this is a test submit form for Schedule your consult Form. Please disregard if received. Thank you.");        
