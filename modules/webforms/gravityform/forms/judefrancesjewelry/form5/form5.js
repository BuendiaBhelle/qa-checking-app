...
async function webforms(domain, timestamp, forms, range_thankyou_page, module_name, launch, webforms) {
    ...
    try {
        ...
        await driver.findElement(By.id("input_5_1_3")).sendKeys("Primeview");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_5_1_6")).sendKeys("Test");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_5_2")).sendKeys("qa@primeview.com");
        await driver.sleep(1000);
        await driver.findElement(By.id("input_5_3")).sendKeys("Please take note that this is a test submit form for General Questions. Please disregard if received. Thank you.");
        await driver.sleep(1000);
