...
const form_page = config.forms.azdoordoctor.form2;
const module_name = config.module_name;
const launch = config.launch.live;
const form = config.webforms.azdoordoctor.live.form2;
...
async function webforms(domain, timestamp) {
    ...
    try {
        ...
        await driver.findElement(By.name("message")).sendKeys("Please take note that this is a test submit form for Contact Us | Sidebar. Please disregard if received. Thank you.");
